...
import com.example.tyudy.ticket2rideclient.presenters.InitDestCardsPresenter;
...
public class InitDestCardsFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mInitDestCardsPresenter = PresenterHolder.SINGLETON.getInitDestCardsPresenter();
        mInitDestCardsPresenter.setInitDestCardsFragment(this);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getDialog().setTitle("Return Unwanted Destination Cards");

        //Set-OnClick-Listeners-----------------------------------------------------
        mExitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mInitDestCardsPresenter.exitClicked();
            }
        });
        ...
        mCard1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mInitDestCardsPresenter.cardClicked(0);
            }
        });
        ...
        mCard2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mInitDestCardsPresenter.cardClicked(1);
            }
        });
        ...
        mCard3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mInitDestCardsPresenter.cardClicked(2);
            }
        });

        ArrayList<DestinationCard> cards = mInitDestCardsPresenter.getmDestCards();
