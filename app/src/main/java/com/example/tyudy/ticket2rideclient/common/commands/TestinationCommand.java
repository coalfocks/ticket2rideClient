...
/**
 * Created by colefox on 4/7/17.
 */

public final class TestinationCommand {

    public static void testit() {
        User megan = new User();
        Destination dest = new Destination("Washington", "Nashville");
        DestinationCard card = new DestinationCard(dest, 100);
        megan.addDestinationCard(card);
        ...
        megan.claimPath(Raleigh_to_Washington);
        megan.claimPath(Pittsburgh_to_Raleigh);
        megan.claimPath(Pittsburgh_to_Nashville);
        if (megan.haveCompletedRoute(card)) {
            System.out.print("YAY");
        } else {
            System.out.print("STUPID TREVOR");
        }
